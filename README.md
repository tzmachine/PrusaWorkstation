This Raspberry Pi 5 hosts a webserver to give control of the PrusaWorkstation. It controls a filter, a ventilation, lights and is connection via serial with the printer to get commands.
